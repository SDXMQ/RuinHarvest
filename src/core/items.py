...
ITEM_DATABASE = {
    ...
    "암호화된 SSD": {
        "category": ItemCategory.QUEST,
        "description": "기밀 데이터가 담긴 암호화된 군용 솔리드 스테이트 드라이브. 플리마켓에서 고가에 거래된다.",
        "stackable": True,
        "max_stack": 5,
        "weight": 0.1,
        "rarity": 0.03,
    ...
    "군용 나침반": {
        "category": ItemCategory.TOOL,
        "description": "혹독한 오염 지대에서도 정상 작동하는 전술 군용 나침반. 플리마켓에서 인기가 높다.",
        "stackable": False,
        "weight": 0.2,
        "rarity": 0.05,
        "value": 10000,
...
LOOT_TABLES = {
    ...
    "factory": [
        ...
        ("CPU", 0.15), ("그래픽카드", 0.03), ("화약", 0.1), ("암호화된 SSD", 0.04),
    ],
    "warehouse": [
