...
class InteriorSystem:
    ...
    def go_upstairs(self):
        ...
        self.game.player.enter_interior(float(self.current_interior.door_pos[0]), float(self.current_interior.door_pos[1]))
    ...
    def go_downstairs(self):
        ...
        # 아래층으로 내려가면 플레이어 위치는 올라가는 계단(stairs_up) 타일 자체
